package com.programmingques.linkedlist.arbitrary.pointer;
...
public class CloneLinkedListWithArbitraryPointer {
    ...
    public static void main(String[] args)
    {
        ...
        LinkedListTemp list = new LinkedListTemp(new Node(5));
        list.push(4);
        list.push(3);
        list.push(2);
        list.push(1);
        ...
        LinkedListTemp clone = list.clone();
...
class LinkedListTemp
{
    ...
    public LinkedListTemp(Node head)
    {
        this.head = head;
    }
    ...
    public LinkedListTemp clone()
    {
        ...
        return new LinkedListTemp(map.get(this.head));
    }
}
